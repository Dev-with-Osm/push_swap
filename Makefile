NAME = push_swap
SRCS = other/error_hundlers.c libft_functions/ft_memmove.c libft_functions/ft_split.c libft_functions/ft_strdup.c libft_functions/ft_strlen.c libft_functions/ft_substr.c \
